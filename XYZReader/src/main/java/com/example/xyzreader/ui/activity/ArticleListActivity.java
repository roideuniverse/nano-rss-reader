        ...
        LoaderManager.LoaderCallbacks<Cursor>
{
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder>
    {
        ...
        public void onBindViewHolder(ViewHolder holder, int position)
        {
            ...
            holder.titleView.setText(mCursor.getString(ArticleCursorLoader.Query.TITLE));
            ...
            holder.thumbnailView.setImageUrl(
                    mCursor.getString(ArticleCursorLoader.Query.THUMB_URL),
                    ImageLoaderHelper.getInstance(ArticleListActivity.this).getImageLoader());
            holder.thumbnailView.setAspectRatio(mCursor.getFloat(ArticleCursorLoader.Query.ASPECT_RATIO));
        }
        ...
        {
            mCursor.moveToPosition(position);
            return mCursor.getLong(ArticleCursorLoader.Query._ID);
        }
